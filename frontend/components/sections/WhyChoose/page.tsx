...
const WhyChooseSection = () => {
  ...
  return (
    <section id="industries" ref={containerRef} className="relative w-full bg-[#050505] py-16 md:py-20 px-6 md:px-24 overflow-hidden">
      
      <div className="max-w-7xl mx-auto mb-16 md:mb-24">
        <motion.div 
          initial={{ opacity: 0 }}
          whileInView={{ opacity: 1 }}
          className="flex items-center gap-4 text-blue-500 font-mono text-[10px] tracking-[0.5em] uppercase mb-4"
        >
      ...
      <div className="max-w-5xl mx-auto relative">
        ...
        {/* FIXED TRACK LOGIC */}
        <div className="absolute left-0 md:left-1/2 top-0 bottom-0 w-[1px] bg-white/10 md:-translate-x-1/2 z-0">
          ...
          >
            ...
            <div className="w-full h-full bg-gradient-to-b from-blue-500 via-emerald-400 to-transparent shadow-[0_0_25px_rgba(59,130,246,0.8)] rounded-full" />
            {/* The "Head" Pulse */}
            ...
            >
              <div className="p-8 rounded-[2rem] bg-[#0c0c0c] border border-white/5 hover:border-white/10 transition-all duration-300">
                <div className="flex items-center gap-4 mb-4">
                  <div className={`p-3 rounded-xl bg-white/5 border border-white/10 text-${step.color}-400 group-hover:scale-110 transition-transform`}>
                    {step.icon}
                  </div>
                  <div>
                     <p className={`text-[9px] font-black uppercase tracking-[0.2em] text-${step.color}-500 mb-0.5`}>{step.subtitle}</p>
      ...
      <div className="max-w-7xl mx-auto mt-12 flex flex-col items-center">
         <div className="h-20 w-px bg-gradient-to-b from-blue-500/30 to-transparent" />
      </div>
    </section>
  );
};
